...
📰 **ARIS-Code v0.4.17** (2026-06) — **the MCP release.** User-configured `mcpServers` finally drive real tool dispatch, and **cross-model adversarial review needs no OpenAI API key**: `aris setup` wires your existing **ChatGPT subscription** in as the reviewer via *Codex MCP* in one step. Capstone of a 13-release polish run (v0.4.5 → v0.4.17) — full per-release detail below. Credits: [@GetIT-Sunday](https://github.com/GetIT-Sunday), [@Anduin9527](https://github.com/Anduin9527), [@GO-player-hhy](https://github.com/GO-player-hhy), [@Jxy-yxJ](https://github.com/Jxy-yxJ), [@screw-44](https://github.com/screw-44), [@StevenUST](https://github.com/StevenUST), [@opposj](https://github.com/opposj), [@ShijunLei-cn](https://github.com/ShijunLei-cn), [@algojogacor](https://github.com/algojogacor).
